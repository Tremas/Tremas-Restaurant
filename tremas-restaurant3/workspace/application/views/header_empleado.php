			 	...
			 	<div class="container">
					...
					<div id="navbar" class="navbar-collapse collapse hidden-print ">
					  <ul class="nav navbar-nav">
						...
						<li><a href="<?php echo base_url('comanda') ?>">Comandas</a></li>
						
						<li><a href="<?php echo base_url('mostrar_reserva') ?>">Reservar</a></li>
						<li><a href="<?php echo base_url('mostrar_factura_reserva') ?>">Cobrar</a></li>
