		...
		<div class="col-md-4">
			...
			<input type='hidden' value='<?php echo $query[0]->id; ?>' name='ida' />
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="name" name="name" placeholder="Introduce tu nombre" value="<?php echo $query[0]->name;?> ">
					<p class="help-block">Escribe tu nombre</p>
				</div>
				<div class="form-group">
					<label for="lastname">Apellidos</label>
					<input type="text" class="form-control" id="lastname" name="lastname" placeholder="Introduce tu apellido"  value="<?php echo $query[0]->lastname;?> ">
